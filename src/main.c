  ...
  for (;;) {
    if (!pegou_maquina) {
      ...
      if (xSemaphoreTake(sem_Maquina1, pdMS_TO_TICKS(1)) == pdTRUE) {
        ...
        contador = 0;
        printf("\033[1;31m\[R1] M1 vazio, R1 trabalhando...\033[0m\n");
      }
    }
    ...
    if (pegou_maquina) {
      ...
      sleep(1);
      if (contador == 1)
        printf("\033[1;31m\[R1] Pegando produto da entrada...\033[0m\r\n");
      else if (contador == 100)
        printf("\033[1;31m\[R1] Movendo produto da entrada para M1...\033[0m\r\n");
      else if (contador == 600)
        printf("\033[1;31m\[R1] Inserindo produto em M1.\033[0m\r\n");
      else if (contador > 700) {
        xSemaphoreGive(sem_Maquina1);
        pegou_maquina = pdFALSE;
        contador = 0;
        printf("\033[1;31m\[R1] Entregue a M1.\033[0m\n");
      }
    }
  ...
  for (;;) {
    if (!ocupando) {
      if (xSemaphoreTake(sem_Maquina1, pdMS_TO_TICKS(1)) == pdTRUE) {
        ocupando = pdTRUE;
        contador = 0;
        printf("\033[45m\[M1] Produto recebido. Iniciando processamento...\033[0m\r\n");
      }
    }
    ...
    if (ocupando) {
      ...
      if (contador == 1500) {
        printf("\033[45m\[M1] Produto processado.\033[0m\r\n");
...
void vRobo2(void * argument) {
  ...
  for (;;) {
    ...
    if (pegou) {
      ...
      contador++;
      if (contador == 1)
        printf("\033[1;32m\[R2] Pegando produto de M1...\033[0m\r\n");
      else if (contador == 100)
        printf("\033[1;32m\[R2] Movendo produto de M1 para M2...\033[0m\r\n");
      else if (contador == 600)
        printf("\033[1;32m\[R2] Inserindo produto em M2.\033[0m\r\n");
      else if (contador > 700) {
        pegou = pdFALSE;
        contador = 0;
...
void vRobo3(void * argument) {
  ...
  for (;;) {
    ...
    if (pegou) {
      ...
      contador++;
      if (contador == 1)
        printf("\033[1;33m\[R3] Pegando produto de M1...\033[0m\r\n");
      else if (contador == 100)
        printf("\033[1;33m\[R3] Movendo produto de M1 para M3...\033[0m\r\n");
      else if (contador == 900)
        printf("\033[1;33m\[R3] Inserindo produto em M3.\033[0m\r\n");
...
void vRobo4(void * argument) {
  ...
  for (;;) {
    ...
    if (pegou_produto == 2 && pegou) {
      ...
      contador++;
      if (contador == 1)
        printf("\033[1;34m\[R4] Pegando produto de M2...\033[0m\r\n");
      else if (contador == 100)
        printf("\033[1;34m\[R4] Movendo produto de M2 para saida...\033[0m\r\n");
      else if (contador == 600)
        printf("\033[1;34m\[R4] Inserindo produto na saida.\033[0m\r\n");
      else if (contador > 700) {
        pegou = pdFALSE;
        contador = 0;
        printf("\033[1;34m\[R4] Produto entregue na saída.\033[0m\r\n");
        xSemaphoreGive(sem_Maquina2);
      }
      ...
      contador++;
      if (contador == 1)
        printf("\033[1;37m\[R4] Pegando produto de M3...\033[0m\r\n");
      else if (contador == 100)
        printf("\033[1;37m\[R4] Movendo produto de M3 para saida...\033[0m\r\n");
      else if (contador == 600)
        printf("\033[1;37m\[R4] Inserindo produto na saida.\033[0m\r\n");
      else if (contador > 700) {
        pegou = pdFALSE;
        contador = 0;
        printf("\033[1;37m\[R4] Produto entregue na saída.\033[0m\r\n");
        xSemaphoreGive(sem_Maquina3);
      }
    }
    vTaskDelay(pdMS_TO_TICKS(1));
